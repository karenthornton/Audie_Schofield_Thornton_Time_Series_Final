...
#Model Fit - Arima (Late) 2
```{r echo=FALSE}
#Fit the late data to an ARIMA
#Model 1: ARIMA
late.arima.good<-auto.arima(late.training.ts.good)
summary(late.arima.good)

late.arima.for.good<-forecast(late.arima.good, h=3)

#Visualize Model
autoplot(late.ts)+
  autolayer(late.arima.for.good, series = "ARIMA")+
  autolayer(late.test.ts.good, series = "Test")

ARIMA_scores_late_good <- accuracy(late.arima.for.good$mean, late.test.ts.good)  #store the performance metrics
