...
#Visualize Model
autoplot(early.ts)+
  autolayer(early.arima.for)+
  autolayer(early.test.ts)
...
#Plot model + observed data
autoplot(early.ts) +
  autolayer(early.NN.for, series="Neural Network",PI=FALSE) + ylab("Funding")
...
>>>>>>> 5d04cdf96293244a47d19a20f6b97975b0a136fc
```
